...
const extConfig = {
  // BEGIN USER OPTIONS
  // You may change the following variables to allowed values listed in the corresponding brackets (* means default).
  // Keep the style and keywords intact.
  ...
  tooltipPercentageMode: "none", // [none*, dash_like, dash_dislike, both, only_like, only_dislike] Mode of
  // showing percentage in like/dislike bar tooltip.
  ...
  if (!rateBar && !isMobile) {
    ...
    getButtons().insertAdjacentHTML(
      ...
      `
        ...
        <tp-yt-paper-tooltip position="top" id="ryd-dislike-tooltip" class="style-scope ytd-sentiment-bar-renderer" role="tooltip"
        tabindex="-1">
           ${tooltipInnerHTML}
        </tp-yt-paper-tooltip>
        </div>
